...
from custom_algos.d3pg.replay_buffer import PriorityReplayBuffer
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def __init__(
        ...
        self.replay_buffer = None  # type: Optional[PriorityReplayBuffer]
    ...
    def load_replay_buffer(self, path: Union[str, pathlib.Path, io.BufferedIOBase]) -> None:
        ...
        assert isinstance(self.replay_buffer, PriorityReplayBuffer), "The replay buffer must inherit from ReplayBuffer class"
