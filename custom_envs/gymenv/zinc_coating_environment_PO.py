...
class ZincCoatingV0_PO(ZincCoatingV0):
    """Simple continous zinc coating environment"""

    def __init__(self, steps_per_episode=5000, coating_reward_time_offset=0, append_is=False, random_coating_targets=True, random_coil_characteristics=True, random_coil_lengths=True, random_coil_speed=True):
        super(ZincCoatingV0_PO, self).__init__(steps_per_episode, coating_reward_time_offset, random_coating_targets, random_coil_characteristics, random_coil_lengths, random_coil_speed)
