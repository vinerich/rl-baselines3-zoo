...
if __name__ == "__main__":  # noqa: C901
    ...
    parser.add_argument("--env", type=str, default="zinc-coating-v0", help="environment ID")
    ...
    parser.add_argument("-n", "--n-timesteps", help="Overwrite the number of timesteps", default=300000, type=int)
